					...
					<tbody>
						...
						<tr>
							<td colspan=5 align="center">
								...
								if (block_nbr > 1) {
								out.print("&nbsp[<a href='boardListPeging.jsp?pageno=1'>" + "맨처음</a>]&nbsp");

								//이전 블록 시작 페이지
								previous_block_start_pageno = block_start_page_no - PAGE_PER_BLOCK;
								out.print("&nbsp[<a href='boardListPeging.jsp?pageno=" + previous_block_start_pageno + "'>이전</a>]&nbsp");
								}
								...
								if (pgn == cur_page_no) {
									...
									out.print("&nbsp[" + "<a href='boardListPeging.jsp?" + "pageno=" + pgn + "'>" + pgn + "</a>]&nbsp");
								}
								}
								...
								out.print("&nbsp[<a href='boardListPeging.jsp?pageno=" + next_block_start_pageno + "'>다음</a>]&nbsp");

								out.print("&nbsp[<a href='boardListPeging.jsp?pageno=" + nbr_of_page + "'>맨끝</a>]&nbsp");
								}
								%>
							</td>
						</tr>
